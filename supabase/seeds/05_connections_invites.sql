...
-- Invite records
insert into invite (id, inviter_id, name, invite_code, used_by, used_at, created_at) values
    -- Alice's used invites
    ('66666666-6666-6666-6666-666666666601', '22222222-2222-2222-2222-222222222201', 'Bob', 'ALICE001', '22222222-2222-2222-2222-222222222202', '2025-10-25 14:30:00+00', '2025-10-24 10:00:00+00'),
    ('66666666-6666-6666-6666-666666666602', '22222222-2222-2222-2222-222222222201', 'Carol', 'ALICE002', '22222222-2222-2222-2222-222222222203', '2025-10-30 09:15:00+00', '2025-10-29 08:00:00+00'),
    -- Bob's used invite
    ('66666666-6666-6666-6666-666666666603', '22222222-2222-2222-2222-222222222202', 'David', 'BOB00001', '22222222-2222-2222-2222-222222222204', '2025-11-04 11:00:00+00', '2025-11-03 15:00:00+00'),
    -- Carol's used invite
    ('66666666-6666-6666-6666-666666666604', '22222222-2222-2222-2222-222222222203', 'Eve', 'CAROL001', '22222222-2222-2222-2222-222222222205', '2025-11-09 16:45:00+00', '2025-11-08 12:00:00+00'),
    -- Unused invites for testing
    ('66666666-6666-6666-6666-666666666605', '22222222-2222-2222-2222-222222222201', 'Test', 'TESTCODE', null, null, '2025-11-17 10:00:00+00'),
    ('66666666-6666-6666-6666-666666666606', '22222222-2222-2222-2222-222222222204', 'James', 'DAVID001', null, null, '2025-11-18 09:00:00+00')
on conflict (id) do nothing;

-- Revoked invite example
insert into invite (id, inviter_id, name, invite_code, revoked_at, created_at) values
    ('66666666-6666-6666-6666-666666666607', '22222222-2222-2222-2222-222222222202', 'Revoked', 'REVOKED1', '2025-11-14 10:00:00+00', '2025-11-12 08:00:00+00')
on conflict (id) do nothing;
