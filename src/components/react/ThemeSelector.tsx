    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown menu */}
          <div
            className="absolute right-0 mt-2 w-48 rounded-lg border border-surface-border bg-surface-elevated z-20 overflow-hidden"
            role="menu"
          >
            <div className="p-2">
              {themes.map((theme) => (
                ...
                >
                  ...
                  <div className={`theme-${theme.name}`}>
                    <div
                      className="flex items-center justify-center gap-1 px-2 py-1.5 rounded border border-black/10 bg-surface"
                      aria-hidden="true"
                    >
                      <div className="w-2 h-2 rounded-full border border-black/10 bg-primary" />
                      <div className="w-2 h-2 rounded-full border border-black/10 bg-secondary" />
                    </div>
                  </div>
