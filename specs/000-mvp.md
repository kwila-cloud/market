...
- [ ] **Setup Supabase integration**
  - [x] Setup Supabase project with the CLI
  - [x] Setup Supabase preview on each pull request
  - [ ] Setup GitHub workflow to configure Cloudflare preview deployments to point at the correct Supabase preview database
  - [ ] Update `INFRASTRUCTURE.md` with Supabase information

- [ ] **Database migrations**
  - [ ] Create initial declarative schemas
  - [ ] Include RLS
  - [ ] Use Supabase CLI to generate initial migrations

- [ ] **Seed data**
  - [ ] Create scripts for adding basic seed data in preview branches
