...
- [x] **Initialize project structure**
   ...
   - [ ] Make large input functional (search/buy request creation) - TODO: Future enhancement
   ...
   - [x] Add GitHub actions for
      ...
      - [x] Type checking
      - [x] Verify formatting
      - [x] Building and deploying to Cloudflare Workers (previews for pull requests, production for main branch)
